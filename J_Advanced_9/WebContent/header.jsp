...
<div id="wrapper" class="animate">
	<nav
		...
		<span class="navbar-toggler-icon leftmenutrigger"></span> <a
			class="navbar-brand" href="#">Internet-Magazine</a>
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav animate side-nav">
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/homepage.jsp">Home </a></li>
				<li class="nav-item"><a class="nav-link"
			...
			<ul class="navbar-nav ml-md-auto d-md-flex">
				<li class="nav-item">
					<button class="nav-link product-logout" style="color:red">LogOut</button>
				</li>
			</ul>
		</div>
	</nav>
